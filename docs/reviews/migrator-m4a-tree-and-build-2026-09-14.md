...
`<prod-admin-account-uuid, redacted>` is verbatim from
...
```
$ echo alert:AlertDefinition-<corpus-uuid, redacted> > sel.txt
...
references `sm_<corpus-uuid, redacted>`
...
```
[8.x] supermetric:<corpus-uuid, redacted>: carried 1, UNCLOSED 2
[8.x] supermetric:<corpus-uuid, redacted>: carried 1, UNCLOSED 2
...
`<prod-admin-account-uuid, redacted>`, the real corpus owner uuid, and my leak
